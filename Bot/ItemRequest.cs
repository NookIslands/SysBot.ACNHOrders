...
namespace SysBot.ACNHOrders
{
    ...
    public sealed class VillagerRequest : Request<VillagerData>
    {
        ...
        {
            if (data == null)
                throw new ArgumentNullException(nameof(data), "VillagerData cannot be null.");
            if (data.Villager == null)
                throw new ArgumentNullException(nameof(data.Villager), "VillagerData.Villager cannot be null.");
